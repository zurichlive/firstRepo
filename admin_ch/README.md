...
Das Programm erstellt aus den lokalen html-Dateien neue csv-Dateien in einem eigenen Unterverzeichnis (\csvs). Pro html-Datei erstellt es eine csv-Datei. Die verarbeiteten html-Dateien verschiebt es ins Archiv.

# Programm zum Checken nach neuen Veranstaltungen

**adminch_serverupdate.py** (work in progress!)
